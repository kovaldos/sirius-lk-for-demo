...
/* harmony import */ var _modules_switch_on_login_in_modal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/switch-on-login-in-modal */ "./js/modules/switch-on-login-in-modal.js");
...
/* harmony import */ var _modules_init_form_validate__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/init-form-validate */ "./js/modules/init-form-validate.js");
/* harmony import */ var _modules_init_mobile_menu__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/init-mobile-menu */ "./js/modules/init-mobile-menu.js");
/* harmony import */ var _modules_change_options__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/change-options */ "./js/modules/change-options.js");
/* harmony import */ var _modules_hide_instructions__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/hide-instructions */ "./js/modules/hide-instructions.js");
/* harmony import */ var _modules_custom_input_type_file__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/custom-input-type-file */ "./js/modules/custom-input-type-file.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_hide_instructions__WEBPACK_IMPORTED_MODULE_8__["initHideInstruction"])(); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_switch_on_login_in_modal__WEBPACK_IMPORTED_MODULE_3__["initSwitchOnLogInModal"])();
    Object(_modules_init_mobile_menu__WEBPACK_IMPORTED_MODULE_6__["initMobileMenu"])();
    Object(_modules_change_options__WEBPACK_IMPORTED_MODULE_7__["initChangeOption"])();
    Object(_modules_custom_input_type_file__WEBPACK_IMPORTED_MODULE_9__["initCustomInputTypeFile"])();
  });
}); // ---------------------------------
...
/***/ "./js/modules/change-options.js":
/*!**************************************!*\
  !*** ./js/modules/change-options.js ***!
  \**************************************/
/*! exports provided: initChangeOption */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initChangeOption", function() { return initChangeOption; });
...
var initChangeOption = function initChangeOption() {
  var recForm = document.querySelector('.recommendations__form');
  var petTypeSelect = recForm.querySelector('.pet-type');
  var petTypeSelectOptions = petTypeSelect.querySelectorAll('[data-value]');
  var recFoodSelect = recForm.querySelector('.rec-food');
  var recFoodSelectOptions = recFoodSelect.querySelectorAll('[data-value]');

  if (recForm) {
    recFoodSelect.style.pointerEvents = 'none';
    recFoodSelectOptions.forEach(function (item) {
      item.classList.add('_hidden');
      petTypeSelectOptions.forEach(function (option) {
      ...
      var showOrHideOptions = function showOrHideOptions(dataValue) {
        item.classList.add('_hidden');
...
/***/ "./js/modules/custom-input-type-file.js":
/*!**********************************************!*\
  !*** ./js/modules/custom-input-type-file.js ***!
  \**********************************************/
/*! exports provided: initCustomInputTypeFile */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initCustomInputTypeFile", function() { return initCustomInputTypeFile; });
// Кастомный инпут type file - начало -
var initCustomInputTypeFile = function initCustomInputTypeFile() {
  var inputs = document.querySelectorAll('.input-type-file');
  inputs.forEach(function (input) {
    var label = input.nextElementSibling;
    var labelVal = label.querySelector('span').innerText;
 ...
 // Кастомный инпут type file - конец -
...
/***/ "./js/modules/hide-instructions.js":
/*!*****************************************!*\
  !*** ./js/modules/hide-instructions.js ***!
  \*****************************************/
/*! exports provided: initHideInstruction */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initHideInstruction", function() { return initHideInstruction; });
// Скрываем инструкцию в меню ЛК для авторизованных пользователей - начало -
var initHideInstruction = function initHideInstruction() {
  var menuItems = document.querySelectorAll('.account__menu-list-item');
  var menuList = document.querySelector('.account__menu-list');
  var instruction = document.querySelector('.account__instructions');
...
var accountFormSuccessCallback = function accountFormSuccessCallback(e) {
  var notification = document.querySelector(".account__notification");
  var form = document.querySelector(".account__form form");
  var inputs = form.querySelectorAll("input");
  var selects = form.querySelectorAll(".custom-select__button");
  var modal = document.querySelector(".modal--success-message");
  e.preventDefault();
  ...
  if (document.querySelector(".account__notification").closest('.create-event__form')) {
    ...
    notification.innerHTML = "<span>Мероприятие добавлено в раздел «Мои мероприятия»</span>";
  } else {
    notification.innerHTML = "<span>Ваши данные отправлены на проверку!</span>";
  }

  notification.style.transition = "none";
  notification.style.maxHeight = "".concat(notification.scrollHeight + 20, "px");
  ...
  Object(_modals_modal__WEBPACK_IMPORTED_MODULE_1__["openModal"])(modal);
};

var accountFormErrorCallback = function accountFormErrorCallback(e) {
  var notification = document.querySelector(".account__notification");
  e.preventDefault();
...
var contactUsFormSuccessCallback = function contactUsFormSuccessCallback(e) {
  var notification = document.querySelector(".contact-us__notification");
  e.preventDefault();
  resetForm(e.target);
  notification.style.transition = "none";
...
var contactUsFormErrorCallback = function contactUsFormErrorCallback(e) {
  var notification = document.querySelector(".contact-us__notification");
  e.preventDefault();
  notification.style.transition = "none";
  notification.style.maxHeight = "".concat(notification.scrollHeight + 20, "px");
...
var initMobileMenu = function initMobileMenu() {
  ...
  var menuBtn = menu.querySelector('.account__menu-btn');
  var menuContent = menu.querySelector('.account__menu-content');
  var menuOverlay = menu.querySelector('.account__menu-overlay');
  ...
  var openMenu = function openMenu() {
    ...
    menuContent.style.maxHeight = "".concat(menuContent.scrollHeight, "px");
  ...
  var onMenuOverlayClick = function onMenuOverlayClick() {
    closeMenu();
  };

  menuBtn.addEventListener('click', onMenuBtnClick); // menuOverlay.addEventListener('click', onMenuOverlayClick);
};
...
var initTabs = function initTabs() {
  ...
  var tabBlocks = document.querySelectorAll('.tabs__item');
...
var modalSuccessMessage = document.querySelector('.modal--success-message');
var modalRecReg = document.querySelector('.modal--recommendations-registration');
var modalProgramRules = document.querySelector('.modal--program-rules');
Object(_modal__WEBPACK_IMPORTED_MODULE_0__["setupModal"])(modalLogIn);
Object(_modal__WEBPACK_IMPORTED_MODULE_0__["setupModal"])(modalSuccessMessage);
Object(_modal__WEBPACK_IMPORTED_MODULE_0__["setupModal"])(modalRecReg);
Object(_modal__WEBPACK_IMPORTED_MODULE_0__["setupModal"])(modalProgramRules); // настраиваем модалки тут, все колбеки импортим, а не создаем из этого модуля простыню
...
/***/ "./js/modules/switch-on-login-in-modal.js":
/*!************************************************!*\
  !*** ./js/modules/switch-on-login-in-modal.js ***!
  \************************************************/
/*! exports provided: initSwitchOnLogInModal */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initSwitchOnLogInModal", function() { return initSwitchOnLogInModal; });
// Переключение табов нижними ссылками на модалке авторизации - начало -
var initSwitchOnLogInModal = function initSwitchOnLogInModal() {
  var otherLinks = document.querySelectorAll('.log-in__link');
    ...
    otherLinks.forEach(function (link) {
      link.addEventListener('click', function (e) {
        ...
        if (target.textContent === 'Войти') {
          document.getElementById('link01').click();
        }
      });
    });
  }
