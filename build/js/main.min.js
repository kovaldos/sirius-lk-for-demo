...
/* harmony import */ var _modules_check_for_invalid__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/check-for-invalid */ "./js/modules/check-for-invalid.js");
/* harmony import */ var _modules_custom_select__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/custom-select */ "./js/modules/custom-select.js");
/* harmony import */ var _modules_init_form_validate__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/init-form-validate */ "./js/modules/init-form-validate.js");
/* harmony import */ var _modules_init_mobile_menu__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/init-mobile-menu */ "./js/modules/init-mobile-menu.js");
/* harmony import */ var _modules_change_options__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/change-options */ "./js/modules/change-options.js");
/* harmony import */ var _modules_hide_instructions__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/hide-instructions */ "./js/modules/hide-instructions.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_hide_instructions__WEBPACK_IMPORTED_MODULE_9__["initHideInstruction"])(); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_check_for_invalid__WEBPACK_IMPORTED_MODULE_4__["initCheckForInvalid"])(); // initMobileMenu();

    Object(_modules_change_options__WEBPACK_IMPORTED_MODULE_8__["initChangeOption"])();
  });
}); // ---------------------------------
...
/***/ "./js/modules/check-for-invalid.js":
/*!*****************************************!*\
  !*** ./js/modules/check-for-invalid.js ***!
  \*****************************************/
/*! exports provided: initCheckForInvalid */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initCheckForInvalid", function() { return initCheckForInvalid; });
// Проверяем элементы формы регистрации на валидность и редактируем прежупреждающий текст - начало -
var initCheckForInvalid = function initCheckForInvalid() {};
